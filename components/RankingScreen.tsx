...
export default function RankingScreen({
  ...
  /*
    ...
    Timing begins when the participant sees the current set of choices.

    It resets after each confirmed choice.
  ...
  */
  ...
  /*
    ...
    The initial option remains recorded when the participant cancels

    the modal. This allows the app to detect a later preference change.
  ...
  */
  ...
  function handleConfirmChoice() {
    ...
    const trackedOption: RankingOption = {
      ...
      initialSelectedOptionId:
        ...
        initialSelectedOptionId || pendingOption.id,
    ...
    /*
      ...
      Begin timing the next choice after the current choice is confirmed.
  ...
  function handleCancelChoice() {
    ...
    /*
      ...
      Do not clear initialSelectedOptionId or preferenceChanged.

      The next selection can therefore be compared with the first one.
  ...
  function removeFromCart(optionId: string) {
    ...
    /*
      ...
      Remove old tracking data before putting the option back.

      New timing will be recorded if it is selected again.
