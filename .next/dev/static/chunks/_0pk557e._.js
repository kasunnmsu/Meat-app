...
"[project]/app/session-3/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getTopThreeSealsFromPreviousChoices(location) {
    const fallbackTopSeals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$locationStudyConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFallbackTopSealsForLocation"])(location);
    try {
        ...
        const validSealIds = new Set((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$locationStudyConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSealsForLocation"])(location).map((seal)=>seal.id));
...
function SessionThreePage() {
    ...
    const [participantLocation, setParticipantLocation] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [currentRoundRanking, setCurrentRoundRanking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [allRoundRankings, setAllRoundRankings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [activeSeal, setActiveSeal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [topThreeSealIds, setTopThreeSealIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const fallbackTopSeals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SessionThreePage.useMemo[fallbackTopSeals]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$locationStudyConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFallbackTopSealsForLocation"])(participantLocation || "PUCPR");
        }
    }["SessionThreePage.useMemo[fallbackTopSeals]"], [
        participantLocation
    ]);
    const sealDefinitions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SessionThreePage.useMemo[sealDefinitions]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$locationStudyConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSealsForLocation"])(participantLocation || "PUCPR").map({
                "SessionThreePage.useMemo[sealDefinitions]": (seal)=>({
                        sealId: seal.id,
                        sealName: seal.name,
                        sealColor: seal.color,
                        sealImageUrl: seal.imageUrl,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionThreePage.useEffect": ()=>{
            async function loadParticipantAndTopSeals() {
                ...
                const locationFallbackTopSeals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$locationStudyConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFallbackTopSealsForLocation"])(location);
                try {
                    ...
                    const validSealIds = new Set((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$locationStudyConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSealsForLocation"])(location).map({
                        "SessionThreePage.useEffect.loadParticipantAndTopSeals": (seal)=>seal.id
                    }["SessionThreePage.useEffect.loadParticipantAndTopSeals"]));
                    if (Array.isArray(data.topSealIds) && data.topSealIds.length >= 3) {
                        const filteredTopSealIds = data.topSealIds.filter({
                            "SessionThreePage.useEffect.loadParticipantAndTopSeals.filteredTopSealIds": (sealId)=>validSealIds.has(sealId)
                        }["SessionThreePage.useEffect.loadParticipantAndTopSeals.filteredTopSealIds"]).slice(0, 3);
    ...
    const randomizationSeed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SessionThreePage.useMemo[randomizationSeed]": ()=>{
            return participantId ? `${participantId}-session-3` : "demo-session-3";
        }
    }["SessionThreePage.useMemo[randomizationSeed]"], [
        participantId
    ]);
    const sessionThreeOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SessionThreePage.useMemo[sessionThreeOptions]": ()=>{
            const selectedSeals = topThreeSealIds.map({
                "SessionThreePage.useMemo[sessionThreeOptions].selectedSeals": (sealId)=>sealDefinitions.find({
                        "SessionThreePage.useMemo[sessionThreeOptions].selectedSeals": (seal)=>seal.sealId === sealId
                    }["SessionThreePage.useMemo[sessionThreeOptions].selectedSeals"])
            }["SessionThreePage.useMemo[sessionThreeOptions].selectedSeals"]).filter(Boolean);
            const currentPriceRotation = priceRotations[currentRoundIndex] || priceRotations[0];
            const pricedOptions = selectedSeals.map({
                "SessionThreePage.useMemo[sessionThreeOptions].pricedOptions": (seal, index)=>{
            ...
            }["SessionThreePage.useMemo[sessionThreeOptions].pricedOptions"]);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$randomization$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["seededShuffle"])(pricedOptions, `${randomizationSeed}-round-${currentRoundIndex + 1}`);
        }
    }["SessionThreePage.useMemo[sessionThreeOptions]"], [
        topThreeSealIds,
        sealDefinitions,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    step === "intro" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    step === "ranking" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    step === "round-confirmation" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        className: "complete-card",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "badge",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                ...
                                children: currentRoundRanking.map((option, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                children: [
                                                    "#",
            ...
            activeSeal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "modal-backdrop",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
...
_s(SessionThreePage, "Mcfx9ueXy7/adiG0fdredbX74bU=");
_c = SessionThreePage;
var _c;
__turbopack_context__.k.register(_c, "SessionThreePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0pk557e._.js.map